...
public class FormalShoe extends Shoe {
    ...
    public FormalShoe(int id, String name, int size, double price, int stok, String jenis, Date tanggal_masuk, String deskripsi) {
        super(id, name, size, price, stok, jenis, new java.sql.Date(tanggal_masuk.getTime()),deskripsi);
        this.style = deskripsi;
    }
    ...
    public void printDescription() {
        System.out.println("Ini adalah Sepatu Formal.");
    }
}
